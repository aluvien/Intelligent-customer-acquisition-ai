...
> 历史资料：该方案中的 `proxy/`、抖音凭证占位符和旧路径不适用于当前版本。当前部署以 `README.md`、`启动说明.md` 和 `docker-compose.yml` 为准；平台适配器尚未核验，不要按本文启动或配置。
...
# 设置环境变量
export DOUYIN_APP_ID=REVOKED_DOUYIN_APP_ID
export DOUYIN_APP_SECRET=REVOKED_DOUYIN_APP_SECRET
